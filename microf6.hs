                                            ...
                                            do
                                                ...
                                                >>= \squigglechar ->
                                                    ...
                                                    if (squigglechar == '~') then
                                                        if ((stringAfterCursor line) == "") then do
                                                            newline <- pure line
                                                            printEditorView newline
                                                            appendToLine (pure newline)
                                                        else do
                                        ...
                                        -- IF up arrow is pressed
                                            ...
                                            do
                                                ...
                                                -- Else move up a line
                                                    ...
                                                    let moveN = newCursorPos - oldCursorPos
                                                    let stringToMove = take moveN (stringAfterCursor line)
                                                    newline <- pure (TELine ((stringBeforeCursor line) ++ stringToMove) (toInteger newCursorPos) (takeOffN (toInteger moveN) (stringAfterCursor line)))
                                                    -- checkingPrintTELine newline
                                                    -- checkingPrintFormat newline
                                                    printEditorView newline
                                                    appendToLine (pure newline)
